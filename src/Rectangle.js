...
export function Rectangle({ id, isSelected, type, ...shapeProps }) {
  ...
  /* 
  we attach handleSelect handler on all interactions, clikc, tap and drag.
  this handler calls the 'selectShape' function from state.js with the id 
  of the shape. 

  onDragEnd executes javascript when the user has finished dragging, we attach 
  the handleDrag when simply calls moveShape. 
  */
  return (
    <>
      <KonvaRectangle
